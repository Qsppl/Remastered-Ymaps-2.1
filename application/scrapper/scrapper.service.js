...
export class ScrapperService {
    ...
    static #getBundleUrls({ hosts, bundles }) {
        try {
            if (!hosts.static || !bundles)
                throw new Error('Отсутствуют данные о хосте или бандлах');
    ...
    static async #downloadAllBundles(urls) {
        try {
    ...
    static async #downloadScript(url) {
